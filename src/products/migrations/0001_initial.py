# Generated by Django 3.2 on 2022-08-26 21:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='Name')),
                ('sku', models.ImageField(upload_to='', verbose_name='sku')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_ad', models.DateTimeField(default=datetime.datetime(2022, 8, 26, 21, 15, 50, 109400, tzinfo=utc))),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='product_reviews', to='products.product', verbose_name='Product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='productsimages', verbose_name='Image')),
